...
if __name__=='__main__':
  ...
  #      argv14 = root_path + _file
    ...
    img_result = '/mnt/sde1/liuhaohome/wubingfang/liuyang_data/img_result'
    if os.path.exists(img_result):
        shutil.rmtree(img_result)
    os.makedirs(img_result)
    # video_path = ''
    #read video_dir and list
	...
	print("*******************")   
	#argv7 = video_path
	#prefix = video_path[:video.rfind('.')]
	#argv8 = predfix + '_ssd_result'
	print(argv7)
	print(argv8)
	print(argv14)
        #print 'get', argv8
        print prefix[:prefix.rfind('.')]
	#print excuted_cmd
	print '--------------------------'
