...
//    }
 ...
 //   char image_filename[2000];
    ...
    while(getline(bz_result,bz_lines)){
        ...
        bbox_file << "/mnt/sde1/liuhaohome/wubingfang/liuyang_data/result/" << bz_line[1] << "/"
        ...
        sprintf(sub_dir_path,"/mnt/sde1/liuhaohome/wubingfang/liuyang_data/result/%i", atoi(bz_line[1].c_str()));
        ...
        for(int cur_frame = 0; cur_frame < atoi(bz_line[0].c_str())+20; cur_frame ++){             // **************************** if cur_frame == biaozhu_frame ***********
            if (cur_frame == atoi(bz_line[0].c_str())){
                ...
                cout << "@@@@@@@@@@@@@@@@@@@@@@@@@@" << endl;
                cout << cur_frame2 << endl;
                cout << "##############################" << endl;
	            cout << cur_frame1 << endl;
                ...
                for(int j = 0; j < out.size(); j++) {
                    ...
                    if (score > threshold[cls]) {
                        ...
                        if(cls == 2){          // **************************** crop image *************************************
                            ...
                            float distance1 = sqrt((re_x_centre - x_centre)*(re_x_centre - x_centre) + (re_y_centre - y_centre)*(re_y_centre - y_centre));
                ...
                int lx = max(0, xmin_min);
                int ly = max(0, ymin_min);
                int rx = min(img.cols, xmax_min);
                int ry = min(img.rows, ymax_min);
               // Rect rect(lx ,ly, max(0, rx - lx), max(0, ry - ly));
                Rect rect(xmin_min ,ymin_min, max(0, xmax_min - xmin_min), max(0, ymax_min - ymin_min));
